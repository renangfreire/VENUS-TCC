...
module.exports = {
    async handle(req, res){
        // res.cookie('cart', JSON.stringify({products: [{id: "9867652"}, {id: '8508534'}, {id: "1532834"}]}), { expires: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000)})
        let products
        ...
        products = await findProductService.execute(idArray)
